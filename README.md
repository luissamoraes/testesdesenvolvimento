...
Você pode clicar [AQUI](https://luissamoraes.github.io/estagio-target-sistemas) e ver a página no ar com os resultados funcionando, ou rolar abaixo e ver as soluções detalhadamente.
<br />
Questão 1 de 5
...
### Solução: [Resultado da Soma](https://github.com/luissamoraes/estagio-target-sistemas/blob/master/scripts/sumResult.js)
...
### Solução: [Fibonacci](https://github.com/luissamoraes/estagio-target-sistemas/blob/master/scripts/isFibonacci.js)
